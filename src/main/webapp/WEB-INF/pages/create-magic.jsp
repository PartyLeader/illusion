...
<head>
    ...
    <title>Добавление магического свойства</title>
...
<jsp:include page="header.jsp">
  <jsp:param name="pageTitle" value="createMagic" />
</jsp:include>
<div class="content container wrap">
    <div class="row">
        <div class="col-md-12">
            <h2 class="page-title">Добавление магического свойства</h2>
        </div>
    </div>
    <div class="row">
        <section class="widget">
            <div class="body">
                <div class="row">
                    <div class="col-md-7">
                        <section class="widget">
                            <form:form action="adminPageMagic" modelAttribute="magic" method="post" onsubmit="true" class="form-horizontal label-left">
                                <div class="control-group">
                                    <label class="control-label">Магия</label>
                                ...
                                <div class="form-actions">
                                    ...
                                    <a href="<c:url value="/adminPageMagic"/>" class="btn btn-inverse btn-lg"><i class="fa eicon-cancel"></i> Отмена</a>
                                </div>
                            </form:form>
                        </section>
                    </div>
