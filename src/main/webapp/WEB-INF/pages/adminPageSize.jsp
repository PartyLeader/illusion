...
<jsp:include page="header.jsp">
    <jsp:param name="pageTitle" value="adminSize"/>
</jsp:include>
...
<div class="content container wrap">
    <div class="row">
        <div class="col-md-12">
            <h2 class="page-title">Админка: Размеры</h2>
        </div>
    </div>
    <div class="row">
        <section class="widget padding-bottom">
            <div class="padding-bottom">
                <a href="<c:url value="/create-size"/>" class="btn btn-success"><i class="fa fa-plus"></i> Добавить размер</a>
            </div>
            <c:if test="${!empty sizeList}">
                <table id="datatable-table" class="table table-striped">
                    ...
                    <thead>
                    <tbody>
                            <c:forEach items="${sizeList}" var="sizes" varStatus="index">
                                    <tr>
                                        <td>${index.count}</td>
                                        <td>${sizes.name}</td>
                                    </tr>
