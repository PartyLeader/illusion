...
////            statement.executeUpdate("CREATE TABLE USER_AUTHENTICATION (USER_ID INTEGER, USERNAME VARCHAR(50), PASSWORD VARCHAR(50), ROLE VARCHAR(50),EMAIL VARCHAR(50), ENABLED BOOLEAN);");
//            statement.executeUpdate("INSERT INTO USER_AUTHENTICATION VALUES(1,'admin','pass1','ROLE_ADMIN','1234',TRUE);");
//            statement.executeUpdate("INSERT INTO USER_AUTHENTICATION VALUES(2, 'user1','pass1','ROLE_USER','1234',TRUE);");
//            statement.executeUpdate("INSERT INTO USER_AUTHENTICATION VALUES(3, 'guest','guest','ROLE_ANONYMOUS','1234',TRUE);");
