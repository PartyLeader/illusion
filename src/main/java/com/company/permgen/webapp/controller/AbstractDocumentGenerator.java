 ...
 * response document.
 */
public class AbstractDocumentGenerator extends AbstractController {

//  protected abstract Object getModel(HttpServletRequest request) throws Exception;

  protected ModelAndView renderDocuments(Object model,HttpServletRequest request, HttpServletResponse response) throws Exception {
    request.setCharacterEncoding("UTF-8");
    renderDocument(model, request, response);
    return null;
  }
